/*****************************************************************************************
   KEI TRUCK — Front Axle Firmware
   ---------------------------------------------------------
   This file is functionally identical to the rear axle firmware.
...
static const uint8_t DEVICE_I2C_ADDRESS = 0x11;   // EX: rear axle = 0x10, front axle = 0x11
...
double _rpm[2] = {0, 0};    // Frequency of the signal on the speed pin
double _mph[2] = {0, 0};    // Wheel speed in revolutions per minute
double _freq[2] = {0, 0};   // Wheel speed in miles per hour             
